...
Total Accepted: 5506 Total Submissions: 12492 Difficulty: Medium
...
/*go through t,
if matching s, increase index,
at the end, check if the index is the length of s,
if it is, return true
else, return false*/
class Solution {
 public:
  bool isSubsequence(string s, string t) {
    if (s.size() == 0) return true;  // consider ""
