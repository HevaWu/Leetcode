...
- if i+(k-stack.count) < n, valid element, prepare append it
=> k-stack.count, number still need to be find
=> i+requiredFindNumber < n, make sure have enough space to find remaining number
