...
if (d>>3)==0b11110, this number should be 4 bytes character ,count = 3
if (d>>7)==0, this number should be 1 bytes character
then check the last n-1 numbers
when count!=0, means we need to continue check if it is a perfect characer number
