...
--> if val-(n-index-1) >= 1, means val-1, val-2, ... val-index, calculate
summation
--> if val-(n-index-1) < 1, means val-1, val-2, ... , 1, 1, 1, 1, calculate
summation
...
class Solution {
 public:
  ...
  bool canFind(int val, int n, int index, int maxSum) {
