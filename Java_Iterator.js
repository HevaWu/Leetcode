...
element[3]=>"Hello"
element[4]=>"Java"
You have to modify the func method by editing at most  lines so that the code only prints the elements after the special string "###". For the sample above the output will be:
